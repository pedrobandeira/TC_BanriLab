 ...
 */
@Entity
@Table(name="historico_reserva_usuarios")
public class HistoricoReservaUsuarios implements Serializable{
    @Id
    ...
    public HistoricoReservaUsuarios() {
    }
    ...
    public boolean equals(Object obj) {
        ...
        final HistoricoReservaUsuarios other = (HistoricoReservaUsuarios) obj;
